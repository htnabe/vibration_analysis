...
b = 0.500; c = 0.050; # •bCŒú‚³c
r = 1.52*10^3; # –§“x
E_xx = 148*10^9; E_yy = 10.50*10^9; # ‘@ˆÛ•ûŒü’e«—¦C‘@ˆÛ‚’¼•ûŒü’e«—¦
E_zz = E_yy; # “ñŸŒ³’¼ŒğˆÙ•û«Ş—¿‚Ìê‡‚Ì‰¼’è
n_xy = 0.30; n_yz = 0.59; n_xz = 0.30; # ƒ|ƒAƒ\ƒ“”ä
n_yx = (E_yy * n_xy)/E_xx; # „‘ª‚³‚ê‚éƒ|ƒAƒ\ƒ“”ä
n_zy = E_zz * n_yz/E_yy;
n_zx = E_zz * n_xz/E_xx;
...
Q_xyxy = 5.61*10^9; Q_yzyz = 3.17*10^9; # ‚¹‚ñ’f’e«ŒW”
Q_xzxz = Q_xyxy; # “ñŸŒ³’¼ŒğˆÙ•û«Ş—¿‚Ìê‡‚Ì‰¼’è
l = m = n = 1; # ƒ‚[ƒhŸ”
...
for cnt = 1:14001
  ...
  # ŠeƒxƒNƒgƒ‹‚Ì‘æ‚Q¬•ªiy²•ûŒü¬•ªj‚ğí‚É³‚É‚·‚é
  if (V(:,1,cnt)(2) >0),
    N_vec_1(:,cnt) = V(:,1,cnt);
  else
    N_vec_1(:,cnt) = -V(:,1,cnt);
