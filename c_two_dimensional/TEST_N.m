function TEST_N(Qxx, Qxy, Qxz, Qyy, Qyz, Qzz, digidity_modulus, mode_degree, measures, N)
    ...
    t_N11 = (pi^2)*(Qxx*((l/leng)^2) + Gxy*((m/width)^2) + Gxz*((n/c)^2));
    t_N12 = (Qxy + Gxy)*(pi^2)*(l*m/(leng*width));
    t_N13 = (Qxz + Gxz)*(pi^2)*(l*n/(leng*thickness));
    t_N21 = t_N12;
    t_N22 = (pi^2)*(Gxy*((l/leng)^2) + Qyy*((m/width)^2) + Gyz*((n/thickness)^2));
    t_N23 = (Qyz + Gyz)*(pi^2)*(m*n/(width*thickness));
    t_N31 = t_N13;
    t_N32 = t_N23;
